...
/*___________________________ Console unsigned number ____________________________*/
/**
...
int p_octal(va_list types, char buf[], int flg, int wdth, int pre, int s)
{
    int i = BUFF_SIZE - 2; 
    unsigned long int num = va_arg(types, unsigned long int);
...
/**
 * p_hexa - show all numbers in hexadecimal format
 * @types: va_list containing all argumen
 * @buf: buff memory used to store the resulting string
 * @flg: frmt flags
 * flg_ch: flag characters
